...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function (e) {
            ...
            setTimeout(() => {
                showFormMessage('Thank you! Your message has been sent. We will contact you shortly.', 'success');
                contactForm.reset();
    ...
    function showFormMessage(text, type) {
        ...
        messageEl.style.background = type === 'success' ? 'rgba(34, 197, 94, 0.2)' : 'rgba(239, 68, 68, 0.2)';
    ...
    document.querySelectorAll('.service-card, .portfolio-item, .why-card, .about-content, .about-images').forEach(el => {
        el.style.opacity = '0';
